...
function GeometricWrapper({
  ...
  return (
    <div
      ...
      className={cn(
        "relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background/30",
        className,
      )}
    >
...
function HeroGeometric({
  ...
  titlePre = "Elevate Your Digital Vision",
  titleSuf = "Crafting Exceptional Websites",
