      ...
      <div className="relative h-[40vh] min-h-[400px] flex items-center justify-center bg-gradient-to-br from-pink-500/20 via-purple-500/20 to-black">
        ...
        <div className="relative z-10 w-full max-w-3xl px-4 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Let our AI create the perfect outfit combinations tailored to your
            occasion, weather, and style preferences.
          </p>
        </div>
      </div>
        ...
        {showSuggestions && (
          <div className="space-y-8 max-w-5xl mx-auto">
            {suggestedOutfits.map((outfit) => (
              <Card
                key={outfit.id}
                className="bg-gray-900/50 backdrop-blur-sm border-white/10 overflow-hidden"
              >
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 mr-2 ${savedOutfits.includes(outfit.id) ? "fill-pink-500 text-pink-500" : ""}`}
                        />
