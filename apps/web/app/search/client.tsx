...
export default function SearchPageClient({ initialData }: { initialData: ProductJson[] }) {
                                    ...
                                    >
                                        ...
                                        <Link href={`/products/${product.slug}`} className="p-4 block">
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <CurrencySymbol currency={product.price.currency} className="text-sm h-4" />
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {[product.itemType, product.occasions[0]].map((tag) => {
                                                    return (
                                                        <span key={tag} className="px-2 py-1 rounded-full text-xs bg-white/10 text-gray-300 uppercase">
                                                            {tag}
                                                        </span>
                                                    );
                                                })}
