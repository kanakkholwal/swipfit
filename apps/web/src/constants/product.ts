...
export const classificationSchema = z.object({
    ...
    .describe("A suitable seo friendly title"),
    shortDescription: z.string()
        .describe("A short description of the product/apparel. This should be a concise description of the product and contains SEO friendly keywords."),
    description: z
        .string()
        .describe(
    ...
    specifications: z
        .object({
            ...
            mainTrend: z
                .string()
                .optional()
                .describe("Main trend associated with the item, e.g., Tropical,denim,old money,etc."),
            neck: z
                .string()
                .optional()
            ...
            occasion: z
                .string()
                .optional()
                .describe("Occasion for which the item is suitable, e.g., Casual,formal,street-wear,etc."),
            pattern: z
                .string()
                .optional()
            ...
            patternCoverage: z
                .string()
                .optional()
                .describe("Pattern coverage of the item, e.g., All-Over,center/chest, left chest,back etc."),
...
export const rawProductSchema = z.object({
    ...
    variants: z.object({
        size: z.array(z.string()).describe("An array of sizes available for the product."),
